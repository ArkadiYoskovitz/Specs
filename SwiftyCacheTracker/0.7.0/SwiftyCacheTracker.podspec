...
Pod::Spec.new do |s|
    ...
    s.homepage          = 'https://github.com/ArkadiYoskovitz/SwiftyCacheTracker'
    ...
    s.source             = { :git => 'https://github.com/ArkadiYoskovitz/SwiftyCacheTracker.git', :tag => s.version.to_s }
    ...
    # s.source_files = 'SwiftyCacheTracker/Classes/**/*'
    ...
    s.resources = 'SwiftyCacheTracker/Assets/**/*'
    
    # s.preserve_paths = "FilesToSave", "MoreFilesToSave"
    # s.resource_bundles = { 'SwiftyCacheTracker' => [ 'SwiftyCacheTracker/Assets/Catalog/**/*.{xcassets}'] }
    ...
    s.subspec 'SubPod_Base' do |spec|
        ...
        # spec.resources = 'SwiftyCacheTracker/Assets/Modules/Gallery.{storyboard}'
    end
    
    # ――― ――――――――――――――――――――――――――――――――――――――――――――――-――――――――――――――――――――――――――― #
    s.subspec 'SubPod_Full' do |spec|
        spec.dependency 'SwiftyCacheTracker/SubPod_Base'
    end
end
